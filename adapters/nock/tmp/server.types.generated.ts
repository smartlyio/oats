...
export type Response$Item$Post = {
    ...
    readonly status: 100 | 200 | 204 | 206 | 301 | 302 | 303 | 304 | 307 | 308 | 400 | 401 | 403 | 404 | 406 | 407 | 410 | 412 | 416 | 418 | 425 | 451 | 500 | 501 | 502 | 503 | 504;
    readonly value: {
        readonly contentType: "application/json";
...
export const makeResponse$Item$Post: oar.make.Maker<ShapeOfResponse$Item$Post, Response$Item$Post> = oar.make.createMaker(function () { return oar.make.makeOneOf(oar.make.makeObject({
    ...
    status: oar.make.makeEnum(100, 200, 204, 206, 301, 302, 303, 304, 307, 308, 400, 401, 403, 404, 406, 407, 410, 412, 416, 418, 425, 451, 500, 501, 502, 503, 504),
    value: oar.make.makeOneOf(oar.make.makeObject({
        contentType: oar.make.makeEnum("application/json"),
        value: makeError
    }))
...
export type Response$Item$Id$Get = {
    ...
    readonly status: 100 | 201 | 204 | 206 | 301 | 302 | 303 | 304 | 307 | 308 | 400 | 401 | 403 | 404 | 406 | 407 | 410 | 412 | 416 | 418 | 425 | 451 | 500 | 501 | 502 | 503 | 504;
    readonly value: {
        readonly contentType: "application/json";
        readonly value: Error;
    };
...
export const makeResponse$Item$Id$Get: oar.make.Maker<ShapeOfResponse$Item$Id$Get, Response$Item$Id$Get> = oar.make.createMaker(function () { return oar.make.makeOneOf(oar.make.makeObject({
    ...
    status: oar.make.makeEnum(100, 201, 204, 206, 301, 302, 303, 304, 307, 308, 400, 401, 403, 404, 406, 407, 410, 412, 416, 418, 425, 451, 500, 501, 502, 503, 504),
    value: oar.make.makeOneOf(oar.make.makeObject({
        contentType: oar.make.makeEnum("application/json"),
        value: makeError
    }))
